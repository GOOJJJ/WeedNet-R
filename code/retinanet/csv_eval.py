...
def evaluate(
    ...
    # all_detections: (img_num,class_num,pre_box_num,5)
    ...
    for label in range(generator.num_classes()):
        ...
        for i,score in enumerate(scores):
            if score <=0.5:
                ...
                # print(i-1)
                break
        score05_idxs.append(score05_idx)
    ...
    for label in range(generator.num_classes()):
        ...
        APs.append(average_precisions[label][0])
        # mAP += average_precisions[label][0]
        print('{}\'s AP: {}'.format(label_name, average_precisions[label][0]))
        print("Precision: ", precisions[label][score05_idxs[label]])
        print("Recall: ", recalls[label][score05_idxs[label]])

    mAP = sum(APs) / generator.num_classes()
    ...
    if save_path != None:
        ...
        plt.title('P-R curve(mAP={:.4f},weed AP={:.4f},crop AP={:.4f})'.format(mAP,APs[0],APs[1]))
