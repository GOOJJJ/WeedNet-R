...
def main(args=None):
    ...
    parser.add_argument('--model_path', help='Path to model', type=str,default=r'./pretrain_models/weednet_r.pt')
    ...
    csv_eval.evaluate(dataset_val, retinanet,iou_threshold=float(parser.iou_threshold),save_path='./results')
